...
const (
	...
	defaultServerAddr    = "localhost:64333"
)

var (
	// Solver
	rtp           = flag.Float64("rtp", 0, fmt.Sprintf("rtp must be in (%0.1f, %0.1f] (required)", minRTP, maxRTP))
	...
	// Server
	serverAddr = flag.String("http", defaultServerAddr, "http server addr")
